    ...
    public partial class AlertsForm : Form
    {
        ...
        private void AddCard() // 카드 추가 (추후 DB 연동 필요)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                card.SetData($"위반 유형 {i + 1}", $"2026-04-11 20:{56 + i}:25", $"Camera {i % 3 + 1} / {(char)('A' + i % 3)}구역", $"ID: {12345 + i}","미해결", null, false);
                alertCards.Add(card);
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.AlertsForm_Load_1);
            this.ResumeLayout(false);

        }
        */
        private void AlertsForm_Load_1(object sender, EventArgs e)
        {
